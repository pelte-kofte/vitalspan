/**
 * Dependency-free SHA-256 for reproducible scientific fingerprints in React Native.
 * This module hashes UTF-8 text only; it does not provide authentication or encryption.
 */
