...
```
Agent(
  prompt="Read /Users/bekircemkusdemir/Downloads/vitalspan/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/templates/VALIDATION.md`
