...
- **Global scope**: `/Users/bekircemkusdemir/Downloads/vitalspan/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bekircemkusdemir/Downloads/vitalspan/.claude/notes/`)
...
2. Glob `/Users/bekircemkusdemir/Downloads/vitalspan/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bekircemkusdemir/Downloads/vitalspan/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bekircemkusdemir/Downloads/vitalspan/.claude/notes/` — works in any directory
