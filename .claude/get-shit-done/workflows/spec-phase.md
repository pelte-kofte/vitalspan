...
```bash
INIT=$(node "/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/templates/spec.md.
