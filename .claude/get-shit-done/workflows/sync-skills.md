...
INSTALL_JS_GLOBAL="/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
