...
```bash
INIT=$(node "/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/bekircemkusdemir/Downloads/vitalspan/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
